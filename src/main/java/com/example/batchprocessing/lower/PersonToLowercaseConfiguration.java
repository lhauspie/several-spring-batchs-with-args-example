...
public class PersonToLowercaseConfiguration {
	...
	@Bean
	public FlatFileItemReader<Person> readerToLowercase() {
	...
	// tag::jobstep[]
	@Bean
	public Job importUserToLowercaseJob(JobCompletionNotificationListener listener, Step step1, ApplicationArguments args) {
	...
	@Bean
	public Step step1(JdbcBatchItemWriter<Person> writerToLowercase, PersonToLowercaseProcessor processorToLowercase) {
		return stepBuilderFactory.get("step1")
			.<Person, Person> chunk(10)
			.reader(readerToLowercase())
			.processor(processorToLowercase)
			.writer(writerToLowercase)
			.faultTolerant()
			.retryLimit(3)
